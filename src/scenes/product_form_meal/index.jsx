      ...
      <div>
        {activeStep === steps.length ? (
          ...
          <div>
            ...
            <div>
                <br/>
                <h2 className="text-center">Give your Meal a short but descriptive name  a code</h2>
...
<br/>
                <h2 className="text-center">What's the type of the Meal</h2>
                ...
                <br/>
                <h2 className="text-center">What's the Estimate Duration of the Meal</h2>
...
>
     ...
     <br/>
                <h2 className="text-center">What is the Location of your Meal</h2>
    ...
    <br/>
            ...
            <div>
            <br/>
            <h2 className="text-center">Tell your travellers what the Meal is all about</h2>
 ...
 <br/>
            <h2 className="text-center">Want to add Photos to your Meal?</h2>
...
{activeStep === 2 &&    <div>
  <br/>
            <h2 className="text-center">Establish your Pricing Strategy.</h2>
