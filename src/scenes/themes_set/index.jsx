...
const GroupsTable = ({ data }) => {
  ...
  const handleRemoveGroup = (id) => {
    ...
    const apiUrl = '/api_/classes/themes';
...
const handleShowInclusions = () => {
  ...
  console.log(">",temporaryId);
    ...
    try {
      const response = await fetch(`/api_/themes/${temporaryId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const updateGroup = async () => {
    ...
    console.log(">",temporaryId);
      ...
      try {
        const response = await fetch(`/api_/classes/themes/${temporaryId}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
...
<Header title="Themes 🔰" subtitle="Create and set up all the Themes available for the Products." />
</div>
{showAddedProductAlert && (
      ...
      <div className="col-md-6">
        <div className="card-body d-flex align-items-center justify-content-center">
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            <h2 className="text-center">Create a New Theme</h2>
            <div style={{ flex: 1, borderBottom: '1px solid black', marginLeft: '10px' }}></div>
          </div>
          <h4 className="text-center" style={{ color: 'gray' }}>Add a new theme to be added to the products.</h4>
          <br />
          <Box
            sx={{
              display: 'flex',
