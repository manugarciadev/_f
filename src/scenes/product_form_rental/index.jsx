...
const steps = [
  ...
  { label: 'Vehicle Specs', icon: <Email /> },
  { label: 'Seasons', icon: <Phone /> },
  { label: 'Price', icon: <Phone /> },
...
// editSeason
  ...
  const handleSeasonsPriceTaggChange = (e, index, field) => {
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary">
            ...
            <TextField
              ...
              onChange={(e) => handleSeasonsPriceTaggChange(e, index, 'pricePerHour')}
            />
            per Night
            <TextField
              fullWidth
              ...
              onChange={(e) => handleSeasonsPriceTaggChange(e, index, 'pricePerDay')}
              sx={{ marginTop: '10px' }}
            />
          </Typography>
    ...
    <div>
       <Button variant="contained" sx={{marginRight:'4px'}} onClick={handleCloseEditRoomModal}>
        ...
        <br/>
                  ...
                  <h4 className="text-center" style={{ color: 'gray' }}>Show travellers even more details in videos about your expirience to give your travellers a better idea of what to expect.</h4>
                  <br/>
                  <Button fullWidth variant="contained" onClick={handleOpenRoomModal}>
            Add Price to Seasons <CheckIcon sx={{marginLeft:'4px'}}/>
        </Button>
