...
<Header title="TRANSPORTATION / TRANSFER 🚌 " subtitle="Create a product with Transfer features" />
<Box
  display="flex"
...
<Box display="flex" justifyContent="space-between" alignItems="center">
      ...
      <div>
        {activeStep === steps.length ? (
          ...
          <div>
            ...
            <div>
                <br/>
                <h2 className="text-center">Give your Transfer a Code</h2>
                ...
                <Box
                  ...
                  <br />
      <h2 className="text-center">What's the total Duration of the Transfer</h2>
      <h4 className="text-center" style={{ color: 'gray' }}>
        Inform your travellers about the duration of your Transfer so they can plan their time accordingly
      </h4>
      <br />
      <Box
        sx={{
      ...
      <br />
      <br />
      <h2 className="text-center">What's the Start Time of the Transfer</h2>
      <h4 className="text-center" style={{ color: 'gray' }}>
        Inform your travellers about the start time of your Transfer so they can plan their time accordingly
      </h4>
      <br />
      <Box
        sx={{
      ...
      >
        ...
        />
                ...
                <h2 className="text-center">What is the Location of your Transfer</h2>
                <h4 className="text-center" style={{ color: 'gray' }}>Inform travellers about the city or town where your Transfer takes place. This will help with filtering and searching online.</h4>
                <br/>
                ...
                <br/>
                <h2 className="text-center">Chose the Themes that best describe your Transfer</h2>
    ...
    <br/>
            ...
            <div>
            <br/>
            <h2 className="text-center">Tell your travellers what the Transfer is all about</h2>
            <h4 className="text-center" style={{ color: 'gray' }}>Describe your Transfer in detail, using exciting and engaging language to capture the essence of the Transfer.</h4>
            <Fab 
            color="info"
            aria-label="add" 
            size="large"
...
<TextField
 ...
 <br/>
            <h2 className="text-center">Want to add Photos to your Transfer?</h2>
            <h4 className="text-center" style={{ color: 'gray' }}>Show travellers even more details about your Transfer to give your travellers a better idea of what to expect.</h4>
            <br/>
            <Container>
      <Grid container spacing={2}>
        ...
        <br/>
            <h2 className="text-center">Want to add videos to your Transfer?</h2>
            <h4 className="text-center" style={{ color: 'gray' }}>Show travellers even more details in videos about your Transfer to give your travellers a better idea of what to expect.</h4>
            <br/>
            ...
            <div>
            <br/>
            <h2 className="text-center">What is Include in your Transfer ?</h2>
            ...
            <TextField fullWidth onChange={handleInclusionsDescriptionChange}
                    ...
                    />
                        ...
                        <br/>
                        <h2 className="text-center">What is NOT Include in your Transfer ?</h2>
      ...
      <Table>
        ...
        <TableBody>
          {ageRanges.map((ar) => (
            ...
            <br/>
            <h2 className="text-center">Would you like to offer multiple rates for your Transfer?</h2>
...
<br/>
  ...
  >
    ...
    >  
        <h1 className="text-center" >Price 💲| Create your Transfer's pricing strategy</h1>
...
<br/>
 ...
 <br/>
            ...
            <h4 className="text-center" style={{ color: 'gray' }}>Inform travellers about how and when their allowed to cancel the Transfer.</h4>
            <br/>
