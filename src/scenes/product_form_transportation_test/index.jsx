...
const [transferTypes, setTransferTypes] = useState(["Auto","Ferry","Flight"]);
...
// 
  ...
  // >>> Setters for variables getLanguage handleT
...
// generateArray
  ...
  const handlePostRequest = async () => {
    ...
    const data = {
      ...
      ...(selectedLocations.length > 0 && {
        startLocation: selectedLocations[0],
        endLocation: selectedLocations[selectedLocations.length - 1],
        // ... outros campos ...
    }),
  ...
  // start-time
    ...
    try {
      console.log(data);
      const response = await fetch('/api_/transfers', {
        method: 'POST',
        headers: {
        ...
        {activeStep === steps.length ? (
          ...
          <div>
            ...
            <div>
               ...
               <br/>
               <br />
                   <h2 className="text-center">What is the Type of your Transfer</h2>
                   <h4 className="text-center" style={{ color: 'gray' }}>Pick the tranfer Type( Auto / Ferry / Flight).</h4>
                   <br/>
                   <Select
                    label="Typology"
                    name="tipo"
                    ...
                    >
                    {transferTypes && transferTypes.length > 0 && transferTypes.map((option, index) => (
