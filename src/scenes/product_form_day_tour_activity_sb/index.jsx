  ...
  const handleAddTime = () => {
    if (hour !== '' && minute !== '') {
      const newTime = {
        ...
        value: `${hour}:${minute}`, // O valor real do start time
      };
...
<Box display="flex" justifyContent="space-between" alignItems="center">
    ...
    <br/>
          ...
          <ListItem
            key="pt"
            onClick={() => handleCloseMenu('pt')}
            button // Adiciona a propriedade button para adicionar estilos de botão padrão
          >
            <ListItemText>
              <Flag country="PT" /> Portuguese
            </ListItemText>
          </ListItem>
          <ListItem
            key="us"
            onClick={() => handleCloseMenu('us')}
            button // Adiciona a propriedade button para adicionar estilos de botão padrão
          >
            <ListItemText>
          ...
          <ListItem
            key="fr"
            onClick={() => handleCloseMenu('fr')}
            button // Adiciona a propriedade button para adicionar estilos de botão padrão
          >
            <ListItemText>
              <Flag country="FR" /> French
            </ListItemText>
          </ListItem>
          <ListItem
            key="es"
            onClick={() => handleCloseMenu('es')}
            button // Adiciona a propriedade button para adicionar estilos de botão padrão
          >
            <ListItemText>
              <Flag country="ES" /> Spanish
            </ListItemText>
          </ListItem>
          <ListItem
            key="de"
            onClick={() => handleCloseMenu('de')}
            button // Adiciona a propriedade button para adicionar estilos de botão padrão
          >
            <ListItemText>
              <Flag country="DE" /> German
            </ListItemText>
          </ListItem>
       </List>
